...
namespace Application.AsyncDataServices
{
    public class MessageBusClient : IMessageBusClient
    {
        ...
        public void PublishNewAcademicStaff(AcademicStaffPublishedDto academicStaffPublishedDto)
        {
            var message = JsonSerializer.Serialize(academicStaffPublishedDto);

            if (_connection.IsOpen)
            {
                Console.WriteLine("--> RabbitMQ Connection Open, sending academicStaff message...");
